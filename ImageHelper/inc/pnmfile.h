...
img::image<img::uchar> *loadPBM(const char *name);
img::image<img::uchar> *loadPBMNoThrow(const char *name);
void savePBM(const img::image<img::uchar> *im, const char *name);
img::image<img::uchar> *loadPGM(const char *name) ;
img::image<img::uchar> *loadPGMNoThrow(const char *name) ;
void savePGM(const img::image<img::uchar> *im, const char *name);
img::image<img::rgb> *loadPPM(const char *name);
img::image<img::rgb> *loadPPMNoThrow(const char *name);
